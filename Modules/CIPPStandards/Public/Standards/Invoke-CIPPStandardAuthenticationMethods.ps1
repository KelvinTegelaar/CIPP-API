function Invoke-CIPPStandardAuthenticationMethods {
    ...
    .DESCRIPTION
        (Helptext) Configures all authentication methods for the tenant including Microsoft Authenticator, FIDO2, SMS, Voice, Email OTP, Temporary Access Pass, Software OATH, Hardware OATH, Certificate-based, and QR Code Pin. Set each method to Enabled, Disabled or Not Configured and optionally target specific groups. Methods set to Not Configured (or left blank) keep the tenant's current setting.
    ...
    .NOTES
        ...
        ADDEDCOMPONENT
            {"type":"autoComplete","multiple":false,"creatable":false,"required":false,"name":"standards.AuthenticationMethods.MicrosoftAuthenticatorEnabled","label":"Microsoft Authenticator","helperText":"Not Configured or blank leaves the tenant's current setting untouched.","options":[{"label":"Enabled","value":true},{"label":"Disabled","value":false},{"label":"Not Configured","value":"notConfigured"}]}
            {"type":"textField","name":"standards.AuthenticationMethods.MicrosoftAuthenticatorGroup","label":"Target Group Name (wildcard supported, blank = All Users)","required":false,"condition":{"field":"standards.AuthenticationMethods.MicrosoftAuthenticatorEnabled","compareType":"valueEq","compareValue":true}}
            {"type":"switch","name":"standards.AuthenticationMethods.MicrosoftAuthenticatorSoftwareOath","label":"Enable Software OTP in Authenticator","defaultValue":false,"condition":{"field":"standards.AuthenticationMethods.MicrosoftAuthenticatorEnabled","compareType":"valueEq","compareValue":true}}
            {"type":"autoComplete","multiple":false,"creatable":false,"label":"Show Application Name in Push Notifications","name":"standards.AuthenticationMethods.MicrosoftAuthenticatorDisplayAppInfo","options":[{"label":"Microsoft managed","value":"default"},{"label":"Enabled","value":"enabled"},{"label":"Disabled","value":"disabled"}],"condition":{"field":"standards.AuthenticationMethods.MicrosoftAuthenticatorEnabled","compareType":"valueEq","compareValue":true}}
            ...
            {"type":"textField","name":"standards.AuthenticationMethods.FIDO2Group","label":"Target Group Name (wildcard supported, blank = All Users)","required":false,"condition":{"field":"standards.AuthenticationMethods.FIDO2Enabled","compareType":"valueEq","compareValue":true}}
            {"type":"autoComplete","multiple":false,"creatable":false,"required":false,"name":"standards.AuthenticationMethods.TAPEnabled","label":"Temporary Access Pass","helperText":"Not Configured or blank leaves the tenant's current setting untouched.","options":[{"label":"Enabled","value":true},{"label":"Disabled","value":false},{"label":"Not Configured","value":"notConfigured"}]}
            {"type":"textField","name":"standards.AuthenticationMethods.TAPGroup","label":"Target Group Name (wildcard supported, blank = All Users)","required":false,"condition":{"field":"standards.AuthenticationMethods.TAPEnabled","compareType":"valueEq","compareValue":true}}
            {"type":"autoComplete","multiple":false,"creatable":false,"label":"TAP Usage Mode","name":"standards.AuthenticationMethods.TAPUsableOnce","options":[{"label":"Only Once","value":"true"},{"label":"Multiple Logons","value":"false"}],"condition":{"field":"standards.AuthenticationMethods.TAPEnabled","compareType":"valueEq","compareValue":true}}
            {"type":"number","name":"standards.AuthenticationMethods.TAPDefaultLifetime","label":"TAP Default Lifetime (minutes)","defaultValue":60,"condition":{"field":"standards.AuthenticationMethods.TAPEnabled","compareType":"valueEq","compareValue":true}}
            {"type":"number","name":"standards.AuthenticationMethods.TAPMinLifetime","label":"TAP Minimum Lifetime (minutes)","defaultValue":60,"condition":{"field":"standards.AuthenticationMethods.TAPEnabled","compareType":"valueEq","compareValue":true}}
            {"type":"number","name":"standards.AuthenticationMethods.TAPMaxLifetime","label":"TAP Maximum Lifetime (minutes)","defaultValue":480,"condition":{"field":"standards.AuthenticationMethods.TAPEnabled","compareType":"valueEq","compareValue":true}}
            {"type":"number","name":"standards.AuthenticationMethods.TAPDefaultLength","label":"TAP Length (characters)","defaultValue":8,"condition":{"field":"standards.AuthenticationMethods.TAPEnabled","compareType":"valueEq","compareValue":true}}
            ...
            {"type":"textField","name":"standards.AuthenticationMethods.SoftwareOathGroup","label":"Target Group Name (wildcard supported, blank = All Users)","required":false,"condition":{"field":"standards.AuthenticationMethods.SoftwareOathEnabled","compareType":"valueEq","compareValue":true}}
            ...
            {"type":"textField","name":"standards.AuthenticationMethods.HardwareOathGroup","label":"Target Group Name (wildcard supported, blank = All Users)","required":false,"condition":{"field":"standards.AuthenticationMethods.HardwareOathEnabled","compareType":"valueEq","compareValue":true}}
            {"type":"autoComplete","multiple":false,"creatable":false,"required":false,"name":"standards.AuthenticationMethods.SMSEnabled","label":"SMS","helperText":"Not Configured or blank leaves the tenant's current setting untouched.","options":[{"label":"Enabled","value":true},{"label":"Disabled","value":false},{"label":"Not Configured","value":"notConfigured"}]}
            {"type":"textField","name":"standards.AuthenticationMethods.SMSGroup","label":"Target Group Name (wildcard supported, blank = All Users)","required":false,"condition":{"field":"standards.AuthenticationMethods.SMSEnabled","compareType":"valueEq","compareValue":true}}
            {"type":"autoComplete","multiple":false,"creatable":false,"required":false,"name":"standards.AuthenticationMethods.VoiceEnabled","label":"Voice Call","helperText":"Not Configured or blank leaves the tenant's current setting untouched.","options":[{"label":"Enabled","value":true},{"label":"Disabled","value":false},{"label":"Not Configured","value":"notConfigured"}]}
            {"type":"textField","name":"standards.AuthenticationMethods.VoiceGroup","label":"Target Group Name (wildcard supported, blank = All Users)","required":false,"condition":{"field":"standards.AuthenticationMethods.VoiceEnabled","compareType":"valueEq","compareValue":true}}
            {"type":"autoComplete","multiple":false,"creatable":false,"required":false,"name":"standards.AuthenticationMethods.EmailEnabled","label":"Email OTP","helperText":"Not Configured or blank leaves the tenant's current setting untouched.","options":[{"label":"Enabled","value":true},{"label":"Disabled","value":false},{"label":"Not Configured","value":"notConfigured"}]}
            {"type":"textField","name":"standards.AuthenticationMethods.EmailGroup","label":"Target Group Name (wildcard supported, blank = All Users)","required":false,"condition":{"field":"standards.AuthenticationMethods.EmailEnabled","compareType":"valueEq","compareValue":true}}
            {"type":"autoComplete","multiple":false,"creatable":false,"label":"Allow external users to use Email OTP","name":"standards.AuthenticationMethods.EmailAllowExternalIdToUseEmailOtp","options":[{"label":"Microsoft managed (default)","value":"default"},{"label":"Enabled","value":"enabled"},{"label":"Disabled","value":"disabled"}],"condition":{"field":"standards.AuthenticationMethods.EmailEnabled","compareType":"valueEq","compareValue":true}}
            {"type":"textField","name":"standards.AuthenticationMethods.EmailExcludeGroup","label":"Exclude Group Name (wildcard supported, blank = no exclusions)","required":false,"condition":{"field":"standards.AuthenticationMethods.EmailEnabled","compareType":"valueEq","compareValue":true}}
            ...
            {"type":"textField","name":"standards.AuthenticationMethods.x509CertificateGroup","label":"Target Group Name (wildcard supported, blank = All Users)","required":false,"condition":{"field":"standards.AuthenticationMethods.x509CertificateEnabled","compareType":"valueEq","compareValue":true}}
            {"type":"autoComplete","multiple":false,"creatable":false,"required":false,"name":"standards.AuthenticationMethods.QRCodePinEnabled","label":"QR Code Pin","helperText":"Not Configured or blank leaves the tenant's current setting untouched.","options":[{"label":"Enabled","value":true},{"label":"Disabled","value":false},{"label":"Not Configured","value":"notConfigured"}]}
            {"type":"textField","name":"standards.AuthenticationMethods.QRCodePinGroup","label":"Target Group Name (wildcard supported, blank = All Users)","required":false,"condition":{"field":"standards.AuthenticationMethods.QRCodePinEnabled","compareType":"valueEq","compareValue":true}}
            {"type":"number","name":"standards.AuthenticationMethods.QRCodeLifetimeInDays","label":"QR Code Lifetime (days, 1-395)","defaultValue":365,"condition":{"field":"standards.AuthenticationMethods.QRCodePinEnabled","compareType":"valueEq","compareValue":true}}
            {"type":"number","name":"standards.AuthenticationMethods.QRCodePinLength","label":"QR Code PIN Length (8-20)","defaultValue":8,"condition":{"field":"standards.AuthenticationMethods.QRCodePinEnabled","compareType":"valueEq","compareValue":true}}
        IMPACT
            High Impact
        ADDEDDATE
            2026-05-28
    ...
    # Determine which methods the user has explicitly configured. The Enabled fields were
    # switches (raw booleans) and are now autoCompletes ({label, value} wrappers) offering
    # Enabled/Disabled/Not Configured - accept both shapes so existing templates keep their
    # behaviour. Anything unrecognised (blank, 'notConfigured') means the method is not
    # managed by this standard and the tenant's current configuration is left untouched.
    $ConfiguredMethods = foreach ($Method in $AuthMethods) {
        $EnabledKey = "$($Method.SettingKey)Enabled"
        $EnabledValue = $Settings.$EnabledKey.value ?? $Settings.$EnabledKey
        $EnabledState = if ("$EnabledValue" -eq 'True' -or "$EnabledValue" -eq 'enabled') { $true }
        elseif ("$EnabledValue" -eq 'False' -or "$EnabledValue" -eq 'disabled') { $false }
        else { $null }
        if ($null -eq $EnabledState) { continue }

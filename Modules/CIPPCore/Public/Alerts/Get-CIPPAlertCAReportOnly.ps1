function Get-CIPPAlertCAReportOnly {
    <#
    .FUNCTIONALITY
        Entrypoint
    #>
    ...
    try {
        ...
        Write-AlertMessage -tenant $($TenantFilter) -message "Conditional Access Report-Only Alert: Error occurred: $(Get-NormalizedError -message $_.Exception.message)"
    }

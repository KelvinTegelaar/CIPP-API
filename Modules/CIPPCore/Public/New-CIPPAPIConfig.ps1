...
"@
        ...
        Write-LogMessage -user $ExecutingUser -API $APINAME -tenant $TenantFilter -message "Succesfully setup CIPP-API Access: $($_.Exception.Message)" -Sev "info"
        ...
        Write-LogMessage -user $ExecutingUser -API $APINAME -tenant $TenantFilter -message "Failed to setup CIPP-API Access: $($_.Exception.Message)" -Sev "Error"
        return @{

...
Function Invoke-ExecCAExclusion {
    ...
    if ($Request.body.vacation -eq 'true') {
        ...
        Set-CIPPCAExclusion -TenantFilter $Request.body.TenantFilter -ExclusionType $Request.body.ExclusionType -UserID $Request.body.UserID -PolicyId $Request.body.PolicyId -Headers $request.headers.'x-ms-client-principal' -UserName $Username
    }

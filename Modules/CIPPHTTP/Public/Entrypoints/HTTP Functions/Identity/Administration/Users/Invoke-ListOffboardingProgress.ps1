function Invoke-ListOffboardingProgress {
    ...
    .ROLE
        Identity.User.Read
    .SYNOPSIS
        Get the live progress of an offboarding or BEC remediation job
    .DESCRIPTION
        Returns the progress rows of an offboarding job started from the wizard, or of a background BEC
    ...
    # The DeploymentId handed back by ExecOffboardUser (also stored on each offboarding task) or ExecBECRemediate

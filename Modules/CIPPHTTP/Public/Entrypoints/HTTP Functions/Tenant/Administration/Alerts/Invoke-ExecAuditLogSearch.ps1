        ...
        default {
            ...
            try {
                ...
                if ($NewSearch.id) {
                    ...
                    Write-LogMessage -headers $Headers -API $APIName -message "Skipped audit log search creation for tenant $TenantFilter because unified auditing is disabled" -Sev 'Warning' -tenant $TenantFilter
                    $Results = @{

function Invoke-ExecCreateDefaultGroups {
    ...
    try {
        ...
        foreach ($Group in $DefaultGroups) {
            ...
            if ($null -ne $Group.ExcludePartnerTenant) {
                $GroupEntity.ExcludePartnerTenant = [bool]$Group.ExcludePartnerTenant
            }

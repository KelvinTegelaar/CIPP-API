A compromised user can register a rogue device under their identity, satisfy compliance, and use the device as a foothold. Restrict joins to a small set of helpdesk / provisioning accounts.

function Set-CIPPDBCacheOrganization {
    ...
    try {
        ...
        New-GraphGetRequest -uri 'https://graph.microsoft.com/beta/organization' -tenantid $TenantFilter -Stream |
            Add-CIPPDbItem -TenantFilter $TenantFilter -Type 'Organization' -AddCount

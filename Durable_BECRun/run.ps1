...
try {
  ...
  $7dayslog = if ($auditLog -eq $false) {
    ...
    do {
      New-ExoRequest -tenantid $Tenantfilter -cmdlet "Search-unifiedAuditLog" -cmdParams $SearchParam -Anchor $SuspectUser
  ...
  TRY {
    ...
    $AuditlogsLogon = (New-ExoRequest -Anchor $SuspectUser -tenantid $Tenantfilter -cmdlet "Search-unifiedAuditLog" -cmdParams $SearchParam  | Sort-Object -Property CreationDate | Select-Object -Last 1).auditdata | ConvertFrom-Json

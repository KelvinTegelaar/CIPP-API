...
try {
    ...
    Log-request "Standards API: $($Tenant) Anonymous Reports Disabled." -sev Info
}
catch {
    Log-request "Standards API: $($Tenant) Failed to disable anonymous reports. Error: $($_.exception.message)"
}
...
try {
    ...
    if ($SecureDefaultsState.IsEnabled -ne $true) {
        ...
        $body = '{ "isEnabled": true }'
    (New-GraphPostRequest -Uri "https://graph.microsoft.com/beta/policies/identitySecurityDefaultsEnforcementPolicy" -Type patch -Body $body -ContentType "application/json")
    }

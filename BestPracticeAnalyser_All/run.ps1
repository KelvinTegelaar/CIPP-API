...
try {
    ...
    $MailboxBPA = New-ExoRequest -tenantid $Tenant -cmdlet "Get-Mailbox" -cmdparams $MailboxBPAParams | Where-Object -Property RecipientTypeDetails -In @('UserMailbox, SharedMailbox')

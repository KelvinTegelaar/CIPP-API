...
try {
    $GraphRequest = New-GraphgetRequest -noauthcheck $true -uri "https://api.securitycenter.microsoft.com/api/machines/SoftwareVulnerabilitiesByMachine?`$top=999" -scope "https://api.securitycenter.microsoft.com/.default" -tenantid $TenantFilter | Group-Object cveid

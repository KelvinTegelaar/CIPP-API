...
try {
      ...
      $Results = [pscustomobject]@{"Results" = "Successfully completed request. See the documentation on how to add your GDAP migration permissions to your SAM application here: " }
}
catch {
